...
class Ptz_Camera():
    def __init__(self):
        self.Objdll = cdll.LoadLibrary('/SDCARD/workspace/cyberdog2_ros2_galactic/ptz_camera/ptz_camera/lib/libhcnetsdk.so')
    ...
    def SetSDKInitCfg(self):
        ...
        strPath = "/SDCARD/workspace/cyberdog2_ros2_galactic/ptz_camera/ptz_camera/lib".encode('utf-8')
        # print(strPath)
