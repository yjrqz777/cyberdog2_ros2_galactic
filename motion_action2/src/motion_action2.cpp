...
#include "motion_action2/motion_action2.hpp"
...
{
  std::string motion_id_map_config = ament_index_cpp::get_package_share_directory("motion_action2") +
...
// {
//   std::string elec_skin_config = ament_index_cpp::get_package_share_directory("motion_action2") +
