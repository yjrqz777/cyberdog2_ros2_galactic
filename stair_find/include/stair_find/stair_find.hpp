...
#ifndef ALGORITHM_MANAGER__EXECUTOR_STAIR_HPP_
#define ALGORITHM_MANAGER__EXECUTOR_STAIR_HPP_
...
class ExecutorStairFind : public ExecutorBase
{
public:
  explicit ExecutorStairFind(std::string node_name);
  void Start(const AlgorithmMGR::Goal::ConstSharedPtr goal) override;
  void Stop(const StopTaskSrv::Request::SharedPtr request, StopTaskSrv::Response::SharedPtr response) override;
