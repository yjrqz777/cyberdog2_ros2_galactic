...
// #include "stair_find/executor_factory.hpp"
...
// namespace algorithm
// {
// AlgorithmTaskManager::AlgorithmTaskManager(): machine::MachineActuator("algorithm_manager")
// {
// }
...
//   start_algo_task_server_ = rclcpp_action::create_server<AlgorithmMGR>(node_, "start_algo_task",

//     std::bind(&AlgorithmTaskManager::HandleAlgorithmManagerGoal,this, std::placeholders::_1, std::placeholders::_2),
//     std::bind(&AlgorithmTaskManager::HandleAlgorithmManagerCancel,this, std::placeholders::_1),
//     std::bind(&AlgorithmTaskManager::HandleAlgorithmManagerAccepted,this, std::placeholders::_1), rcl_action_server_get_default_options());
...
//     auto executor_ptr = CreateExecutor(task_ref.id, task_name);
